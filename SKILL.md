...
| 🚫 禁用用户 | L3 | — |
| 🔌 数据源连接/结构变更 | L3 | — |
| 🧪 版本适配 | 动态 | 已适配至 `2.10.26`；`2.10.27+` 默认只读，`DATAEASE_ALLOW_UNVERIFIED_VERSION=true` 仅在隔离兼容性测试中使用 |
